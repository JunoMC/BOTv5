...
public class KICK {
    ...
    public KICK(String cmd, @Nullable String[] args, Message msg) {
        this.cmd = cmd;
        this.args = args;
        this.msg = msg;
    }
    ...
    public void execute(String prefix, User sender, TextChannel textChannel, List<String> staffs, String adminRole) {
        if (!cmd.equalsIgnoreCase("KICK")) return;
        ...
        if (args == null) {
            ...
            embed.setColor(Color.HSBtoRGB(0, 100, 57));
            embed.setTitle("USAGE: " + prefix + "KICK <USER> [REASON]");
        ...
        if (banUser == sender) {
            ...
            embed.setColor(Color.HSBtoRGB(0, 100, 57));
            embed.setDescription("You can not kick your self!");
            embed.setFooter("https://autobuy.io/@PurseAlts");
            embed.setTimestamp(msg.getTimeCreated());
        ...
        assert banUser != null;
        textChannel.getGuild().kick(Objects.requireNonNull(textChannel.getGuild().getMember(banUser))).queue();
        ...
        embed.addField("KICKED:", banUser.getAsTag(), true);
